  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: [
        ...
        "I'm working as Frontend Developer since 2017 I try to follow up-to-date technologies related to software, mostly frontend.",
        " You can follow the links below to get to know me better and follow my accounts.",
      ],
      typeSpeed: 30,
      backSpeed: 30,
      backDelay: 500,
